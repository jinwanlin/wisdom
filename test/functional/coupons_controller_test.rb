...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { category: @coupon.category, cover: @coupon.cover, desc: @coupon.desc, expire: @coupon.expire, name: @coupon.name, title: @coupon.title }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { category: @coupon.category, cover: @coupon.cover, desc: @coupon.desc, expire: @coupon.expire, name: @coupon.name, title: @coupon.title }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
