...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { desc: @community.desc, location: @community.location, name: @community.name, score: @community.score }
    end
  ...
  test "should update community" do
    put :update, id: @community, community: { desc: @community.desc, location: @community.location, name: @community.name, score: @community.score }
    assert_redirected_to community_path(assigns(:community))
  end
